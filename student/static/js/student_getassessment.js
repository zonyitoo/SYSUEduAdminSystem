    ...
    $.ajax({
        ...
        success: function(msg,textStatus,jqXHR)
        {
            ...
            for (var i = 0;i < assessment.length;i++)
            {
                ...
                assessment_block.append("<div class='accordion-group'><div class='accordion-heading'><div class='accordion-toggle' data-toggle='collapse' data-parent='#assessment-" + i + "' data-target='#assessment-0-" + i + "'><strong>外貌</strong></div></div><div id='assessment-0-" + i + "' class='accordion-body collapse'><div class='accordion-inner'>0分不能再多了</div></div></div>");
