...
function getPlan()
{
    $.ajax({
        ...
        success: function(msg,textStatus,jqXHR)
        {
            ...
            $("#plan-result").empty();
            $("#plan-result").append("<table class='table table-bordered table-hover table-condensed'><thead><tr><th>类别</th><th>应修学分</th><th>已修学分</th><th>平均绩点</th></tr></thead><tbody id='plan-list'></tbody></table>");
            $("#plan-list").append("<tr><td>公必</td><td>" + pr_req + "</td><td>" + pr_credit + "</td><td>" + pr_gpa + "</td></tr><tr><td>公选</td><td>" + po_req + "</td><td>" + po_credit + "</td><td>" + po_gpa + "</td></tr><tr><td>专必</td><td>" + mr_req + "</td><td>" + mr_credit + "</td><td>" + mr_gpa + "</td></tr><tr><td>专选</td><td>" + mo_req + "</td><td>" + mo_credit + "</td><td>" + mo_gpa + "</td></tr><tr><td>合计</td><td>" + (pr_req + po_req + mr_req + mo_req) + "</td><td>" + (pr_credit + po_credit + mr_credit + mo_credit) + "</td><td>" + gpa + "</td></tr>");
