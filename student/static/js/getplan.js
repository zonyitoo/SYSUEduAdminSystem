    ...
    $.ajax({
        ...
        success: function(msg)
        {
            ...
            for (i = 0; i < tot; i++)
            {
                ...
                $("#plan-list").append("<tr><td class='" + index + "'>" + index + "</td><td>" + courseName + "</td><td>" + courseType + "</td><td>" + credit + "</td><td>" + teacher + "</td><td>" + exam + "</td><td>" + period + "</td><td>" + time + "</td><td>" + capacity + "</td></tr>");
            }
        }
    });
}
